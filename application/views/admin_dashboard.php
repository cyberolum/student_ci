...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?= base_url(); ?>public/css/theme-default/libs/rickshaw/rickshaw.css?1422792967" />
    <link type="text/css" rel="stylesheet" href="<?= base_url(); ?>public/css/theme-default/libs/morris/morris.core.css?1420463396" />
    <!-- END STYLESHEETS -->
                    ...
                    <ul class="dropdown-menu animation-expand">
                        ...
                        <li>
                            <a class="alert alert-callout alert-warning" href="javascript:void(0);">
                                <img class="pull-right img-circle dropdown-avatar" src="<?= base_url(); ?>uploads/img/avatar2.jpg?1404026449" alt="" />
                        ...
                        <li>
                            <a class="alert alert-callout alert-info" href="javascript:void(0);">
                                <img class="pull-right img-circle dropdown-avatar" src="<?= base_url(); ?>uploads/img/avatar3.jpg?1404026799" alt="" />
            ...
            <ul class="header-nav header-nav-profile">
                <li class="dropdown">
                    <a href="javascript:void(0);" class="dropdown-toggle ink-reaction" data-toggle="dropdown">
                        <img src="<?= base_url(); ?>uploads/img/avatar1.jpg?1403934956" alt="" />
                    ...
                    <ul class="dropdown-menu animation-dock">
                        ...
                        <li><a href="<?= base_url(); ?>home/"><i class="fa fa-fw fa-power-off text-danger"></i> Logout</a></li>
                    </ul><!--end .dropdown-menu -->
                    <ul class="dropdown-menu animation-dock">
                        <li><a href="<?= base_url(); ?>home/"><i class="fa fa-fw fa-power-off text-danger"></i> Ana Sehife</a></li>
                    </ul>
                </li><!--end .dropdown -->
        ...
        <div id="offcanvas-chat" class="offcanvas-pane style-default-light width-12">
            ...
            <div class="offcanvas-body">
                <ul class="list-chats">
                    <li>
                        <div class="chat">
                            <div class="chat-avatar"><img class="img-circle" src="<?= base_url(); ?>uploads/img/avatar1.jpg?1403934956" alt="" /></div>
                            <div class="chat-body">
                    ...
                    <li class="chat-left">
                        <div class="chat">
                            <div class="chat-avatar"><img class="img-circle" src="<?= base_url(); ?>uploads/img/avatar9.jpg?1404026744" alt="" /></div>
                            <div class="chat-body">
